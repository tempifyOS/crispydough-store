    ...
    <Container>
      <div className="py-10 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-lg text-gray-700 mb-6">
          At <a href="/" className="text-blue-500 underline">Crispy Dough Bakery</a>, we take your payment security seriously. That's why we utilize Stripe, a trusted and secure payment processing platform, to handle all transactions on our website.
        </p>
        <p className="text-lg text-gray-700 mb-6">
        ...
        <p className="text-lg text-gray-700 mb-6">
          Your trust and confidence in our payment process are paramount to us. If you have any questions or concerns about payment safety or our use of Stripe, please don't hesitate to <a href="/contact" className="text-blue-500 underline">contact us</a>.
        </p>
      </div>
    </Container>
  );
